...
var page = require('webpage').create(),
	...
	address, output, pixelRatio, width, height, dimensions;
...
address = args[0];
output = args[1];
dimensions = [parseInt(args[2]), parseInt(args[3])];
pixelRatio = args[4];
...
width = (dimensions[0]*pixelRatio);
height = (dimensions[1]*pixelRatio);
